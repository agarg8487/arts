	...
	<div class="container">
		<div class="row main">
			...
			<div class="main-login main-center">
				<form class="form-horizontal" method="post"  onsubmit="return check()" action="db/register_user.php">
					...
					<div class="form-group">
						...
						<div class="cols-sm-10">
							<div class="input-group">
								...
								<input type="number" class="form-control" name="zipcode" id="zipcode"  placeholder="Enter your Zipcode"/>
							</div>
					...
					<div class="form-group ">
						<input type="submit" name= "register" class="btn btn-primary btn-lg btn-block login-button"/>
					</div>
				</form>
			</div>
			<div class="panel-heading">
